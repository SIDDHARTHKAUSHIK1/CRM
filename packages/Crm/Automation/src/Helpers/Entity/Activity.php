...
namespace Crm\Automation\Helpers\Entity;

use Carbon\Carbon;
use Illuminate\Support\Facades\Mail;
use Crm\Activity\Contracts\Activity as ContractsActivity;
use Crm\Activity\Repositories\ActivityRepository;
use Crm\Admin\Notifications\Common;
use Crm\Attribute\Repositories\AttributeRepository;
use Crm\Automation\Repositories\WebhookRepository;
use Crm\Automation\Services\WebhookService;
use Crm\Contact\Repositories\PersonRepository;
use Crm\EmailTemplate\Repositories\EmailTemplateRepository;
