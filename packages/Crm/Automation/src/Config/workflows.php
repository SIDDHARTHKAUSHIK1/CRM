...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name' => 'Leads',
            'class' => 'Crm\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name' => 'Activities',
            'class' => 'Crm\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name' => 'Persons',
            'class' => 'Crm\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name' => 'Quotes',
            'class' => 'Crm\Automation\Helpers\Entity\Quote',
            'events' => [
                [
