...
use Crm\Admin\Http\Controllers\Settings\AttributeController;
use Crm\Admin\Http\Controllers\Settings\DataTransfer\ImportController;
use Crm\Admin\Http\Controllers\Settings\EmailTemplateController;
use Crm\Admin\Http\Controllers\Settings\GoogleContactController;
use Crm\Admin\Http\Controllers\Settings\GroupController;
use Crm\Admin\Http\Controllers\Settings\LocationController;
use Crm\Admin\Http\Controllers\Settings\Marketing\CampaignsController;
use Crm\Admin\Http\Controllers\Settings\Marketing\EventController;
use Crm\Admin\Http\Controllers\Settings\PipelineController;
use Crm\Admin\Http\Controllers\Settings\RoleController;
use Crm\Admin\Http\Controllers\Settings\SettingController;
use Crm\Admin\Http\Controllers\Settings\SourceController;
use Crm\Admin\Http\Controllers\Settings\TagController;
use Crm\Admin\Http\Controllers\Settings\TypeController;
use Crm\Admin\Http\Controllers\Settings\UserController;
use Crm\Admin\Http\Controllers\Settings\Warehouse\ActivityController;
use Crm\Admin\Http\Controllers\Settings\Warehouse\TagController as WarehouseTagController;
use Crm\Admin\Http\Controllers\Settings\Warehouse\WarehouseController;
use Crm\Admin\Http\Controllers\Settings\WebFormController;
use Crm\Admin\Http\Controllers\Settings\WebhookController;
use Crm\Admin\Http\Controllers\Settings\WorkflowController;
