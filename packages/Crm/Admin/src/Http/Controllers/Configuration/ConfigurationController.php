...
namespace Crm\Admin\Http\Controllers\Configuration;
...
use Crm\Admin\Http\Requests\ConfigurationForm;
use Crm\Core\Repositories\CoreConfigRepository as ConfigurationRepository;
