...
namespace Crm\Admin\Http\Controllers\Lead;
...
use Crm\Admin\DataGrids\Lead\LeadDataGrid;
use Crm\Admin\Http\Controllers\Controller;
use Crm\Admin\Http\Requests\LeadForm;
use Crm\Admin\Http\Requests\MassDestroyRequest;
use Crm\Admin\Http\Requests\MassUpdateRequest;
use Crm\Admin\Http\Resources\LeadResource;
use Crm\Admin\Http\Resources\StageResource;
use Crm\Attribute\Repositories\AttributeRepository;
use Crm\Contact\Repositories\PersonRepository;
use Crm\DataGrid\ColumnTypes\Date as DateColumn;
use Crm\DataGrid\Enums\DateRangeOptionEnum;
use Crm\Lead\Helpers\MagicAI;
use Crm\Lead\Repositories\LeadRepository;
use Crm\Lead\Repositories\PipelineRepository;
use Crm\Lead\Repositories\ProductRepository;
...
use Crm\Lead\Services\MagicAIService;
use Crm\Quote\Repositories\QuoteItemRepository;
