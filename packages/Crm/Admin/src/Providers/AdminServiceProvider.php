...
use Crm\Admin\Bouncer;
use Crm\Admin\Exceptions\Handler;
use Crm\Admin\Http\Middleware\Bouncer as BouncerMiddleware;
use Crm\Admin\Http\Middleware\Locale;
use Crm\Admin\Http\Middleware\SanitizeUrl;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerFacades(): void
    {
        ...
        $loader->alias('Bouncer', \Crm\Admin\Facades\Bouncer::class);
