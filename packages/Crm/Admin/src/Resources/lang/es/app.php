...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desarrollado por :crm, un proyecto de código abierto de :crm.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Búsqueda Mega',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Todo lo que necesitas para sacar el máximo partido a CRM Admin: alojamiento, soporte y servicios profesionales, además de extensiones y documentación para desarrolladores.',
            'contact-us' => 'Contáctanos',
            'view-all' => 'Ver todo',
            'still-need-help-title' => '¿Todavía necesitas ayuda?',
            'still-need-help-description' => 'Habla con el equipo de CRM sobre alojamiento, desarrollo personalizado o cualquier otra cosa.',

            'services' => [
                'title' => 'Servicios y recursos',
                'cloud-hosting' => [
                    'title' => 'Alojamiento en la nube',
                    'description' => 'Alojamiento en la nube gestionado y rentable: prueba y lanza CRM en la nube en minutos, totalmente optimizado y escalable.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensiones',
                    'description' => 'Explora complementos oficiales y de la comunidad para ampliar CRM con nuevos conectores, canales y funciones.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    ...
                    'description' => 'Referencia completa de la API REST con endpoints, autenticación y ejemplos para integrar CRM con tu stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Conecta con miles de usuarios y desarrolladores de CRM para compartir consejos y resolver problemas.',
