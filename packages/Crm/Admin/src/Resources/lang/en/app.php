...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => '&copy; :year :app. All rights reserved.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Mega Search',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Everything you need to get the most out of your CRM — documentation, guides, and support resources.',
            'contact-us' => 'Contact us',
            'view-all' => 'View all',
            'still-need-help-title' => 'Still need a hand?',
            'still-need-help-description' => 'Reach out to the support team for assistance.',

            'services' => [
                'title' => 'Services & Resources',
                'cloud-hosting' => [
                    'title' => 'Cloud Hosting',
                    'description' => 'Managed cloud hosting — scalable, secure and optimised infrastructure.',
                ],
                'support' => [
                    'title' => 'Support & Maintenance',
                    'description' => 'Dedicated technical support to keep your CRM secure, updated and running smoothly.',
                ],
                'extensions' => [
                    'title' => 'Extensions',
                    'description' => 'Extend your CRM with connectors, channels, integrations and custom features.',
                ],
            ],
            ...
            'resources' => [
                ...
                'user-docs' => [
                    'title' => 'User Guide',
                    'description' => 'Comprehensive guides for features, pipelines, contacts, and workflow management.',
                ],
                'dev-docs' => [
                    'title' => 'Dev Docs & Guides',
                    'description' => 'Developer documentation and tutorials to help you customize and extend the system.',
                ],
                'api-docs' => [
                    'title' => 'API Docs',
                    'description' => 'Full REST API reference with endpoints, authentication and examples for integrations.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Connect with other users and developers to share tips and solve problems.',
                    'link' => 'Join the community',
                ],
                'tutorials' => [
                    'title' => 'Video Tutorials',
                    'description' => 'Watch step-by-step video guides on setting up and managing your CRM.',
                    'link' => 'Browse tutorials',
                ],
            ],
        ],
    ],
    ...
    'admin-panel' => [
        ...
        'impersonate' => [
            'banner_text' => 'Viewing as :name — Return to Admin',
            'return_btn' => 'Return to Admin',
            'success' => 'Logged in as :name.',
            'stop_success' => 'Returned to Administrator session.',
            'cannot_impersonate_admin' => 'Impersonating another administrator account is restricted.',
            'modal_title' => 'Switch Account',
            'modal_message' => 'Are you sure you want to log in as :name? You will browse the CRM with their permissions.',
            'btn' => 'Login as Employee',
            'cancel' => 'Cancel',
            'confirm' => 'Confirm & Switch',
        ],
        'employees' => [
            'title' => 'Employees Oversight',
            'description' => 'Oversee employee accounts, work activity, passwords, and permissions.',
            'total-employees' => 'Total Accounts',
            'active-employees' => 'Active',
            'inactive-employees' => 'Inactive',
            'create-btn' => 'Add Employee',
            'create-title' => 'Create New Employee Account',
            'create-success' => 'Employee account created successfully.',
            'admin-role-warning' => 'Warning: You are assigning Administrator permissions (full access) to this account.',
            'create' => [
                'name' => 'Full Name',
                'email' => 'Email Address',
                'password' => 'Password',
                ...
                'active' => 'Active',
                'inactive' => 'Inactive',
                'save-btn' => 'Create Employee',
                'cancel-btn' => 'Cancel',
            ],
            'view' => [
                'title' => 'Employee Details: :name',
                'back-btn' => 'Back to Employees',
                'overview' => 'Employee Overview',
                'work-summary' => 'Work Summary',
                'leads' => 'Assigned Leads',
                'quotes' => 'Created Quotes',
                'activities' => 'Activities & Tasks',
                'no-leads' => 'No leads assigned yet.',
                'no-quotes' => 'No quotes created yet.',
                'no-activities' => 'No activities recorded yet.',
            ...
            'password' => [
                'modal-title' => 'Password Management: :name',
                'tab-reveal' => 'Reveal Password',
                'tab-reset' => 'Set New Password',
                'admin-password-prompt' => 'Enter your Administrator password to reveal this employee\'s password:',
                'admin-password-label' => 'Your Admin Password',
                'admin-password-placeholder' => 'Enter your current password',
                'reveal-btn' => 'Verify & Reveal',
                'revealed-title' => 'Stored Plaintext Password',
                'copy-btn' => 'Copy',
                'copied' => 'Copied!',
                'new-password-label' => 'New Password',
                'confirm-password-label' => 'Confirm Password',
                'reset-btn' => 'Update Password',
                'reset-success' => 'Employee password updated successfully.',
                'invalid-admin-password' => 'The provided administrator password is incorrect.',
                'no-plain-password' => 'No recoverable password on record for this user. You can set a new one using the form below.',
                'rate-limit-error' => 'Too many reveal attempts. Please try again in a moment.',
            ],
            'delete' => [
                'modal-title' => 'Delete Employee Account',
                'modal-message' => 'Are you sure you want to permanently delete :name? This will immediately revoke their ability to access the CRM.',
                'confirm' => 'Delete Account',
                'cancel' => 'Cancel',
                'success' => 'Employee account deleted successfully.',
                'cannot-delete-self' => 'You cannot delete your own account from this panel.',
                'cannot-delete-last-admin' => 'You cannot delete the last remaining Administrator account.',
                'cannot-delete-last-user' => 'You cannot delete the last remaining user account.',
            ],
            'datagrid' => [
                'id' => 'ID',
                'name' => 'Employee',
                ...
                'view' => 'View Details',
                'edit' => 'Edit Employee',
                'password' => 'Password (Reveal / Reset)',
                'impersonate' => 'Login as this Employee',
