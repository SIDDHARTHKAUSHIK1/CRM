...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Powered by :crm, an open-source project by :crm.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'البحث الشامل',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'كل ما تحتاجه لتحقيق أقصى استفادة من لوحة تحكم CRM — الاستضافة والدعم والخدمات الاحترافية، بالإضافة إلى الإضافات ووثائق المطوّرين.',
            'contact-us' => 'اتصل بنا',
            'view-all' => 'عرض الكل',
            'still-need-help-title' => 'هل ما زلت بحاجة إلى مساعدة؟',
            'still-need-help-description' => 'تحدّث مع فريق CRM حول الاستضافة أو التطوير المخصص أو أي شيء آخر.',

            'services' => [
                'title' => 'الخدمات والموارد',
                'cloud-hosting' => [
                    'title' => 'الاستضافة السحابية',
                    'description' => 'استضافة سحابية مُدارة وفعّالة من حيث التكلفة — جرّب وأطلق CRM على السحابة في دقائق، مُحسّنة بالكامل وقابلة للتوسّع.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'الإضافات',
                    'description' => 'تصفّح الإضافات الرسمية وإضافات المجتمع لتوسيع CRM بموصّلات وقنوات وميزات جديدة.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'وثائق API',
                    'description' => 'مرجع كامل لواجهة REST API مع نقاط النهاية والمصادقة وأمثلة لدمج CRM مع نظامك.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'تواصل مع آلاف المستخدمين والمطوّرين الآخرين في CRM لتبادل النصائح وحل المشكلات.',
