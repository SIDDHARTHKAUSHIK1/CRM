...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Được hỗ trợ bởi :crm, một dự án mã nguồn mở được phát triển bởi :crm.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Tìm kiếm Mega',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Mọi thứ bạn cần để tận dụng tối đa CRM Admin — lưu trữ, hỗ trợ và dịch vụ chuyên nghiệp, cùng với tiện ích mở rộng và tài liệu dành cho nhà phát triển.',
            'contact-us' => 'Liên hệ với chúng tôi',
            'view-all' => 'Xem tất cả',
            'still-need-help-title' => 'Vẫn cần trợ giúp?',
            'still-need-help-description' => 'Trao đổi với đội ngũ CRM về lưu trữ, phát triển tùy chỉnh hoặc bất kỳ vấn đề nào khác.',

            'services' => [
                'title' => 'Dịch vụ & Tài nguyên',
                'cloud-hosting' => [
                    'title' => 'Lưu trữ đám mây',
                    'description' => 'Dịch vụ lưu trữ đám mây được quản lý, tiết kiệm chi phí — dùng thử và khởi chạy CRM trên đám mây trong vài phút, được tối ưu hóa toàn diện và có khả năng mở rộng.',
                ],
                'support' => [
                ...
                'extensions' => [
                    ...
                    'description' => 'Duyệt các tiện ích bổ sung chính thức và từ cộng đồng để mở rộng CRM với các trình kết nối, kênh và tính năng mới.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'Tài liệu API',
                    'description' => 'Tài liệu tham khảo API REST đầy đủ với các điểm cuối, xác thực và ví dụ để tích hợp CRM vào hệ thống của bạn.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Kết nối với hàng nghìn người dùng và nhà phát triển CRM khác để chia sẻ mẹo và giải quyết vấn đề.',
