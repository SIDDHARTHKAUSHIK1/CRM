...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => ':crm tarafından geliştirilen açık kaynaklı bir proje olan :crm tarafından desteklenmektedir.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Mega Arama',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'CRM Admin panelinden en iyi şekilde yararlanmanız için gereken her şey — barındırma, destek ve profesyonel hizmetlerin yanı sıra eklentiler ve geliştirici dokümantasyonu.',
            'contact-us' => 'Bize ulaşın',
            'view-all' => 'Tümünü gör',
            'still-need-help-title' => 'Hâlâ yardıma mı ihtiyacınız var?',
            'still-need-help-description' => 'Barındırma, özel geliştirme veya başka her konuda CRM ekibiyle görüşün.',

            'services' => [
                'title' => 'Hizmetler ve Kaynaklar',
                'cloud-hosting' => [
                    'title' => 'Bulut Barındırma',
                    'description' => 'Uygun maliyetli, yönetilen bulut barındırma — CRM uygulamasını dakikalar içinde bulutta deneyip yayına alın; tamamen optimize edilmiş ve ölçeklenebilir.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Eklentiler',
                    'description' => 'CRM uygulamasını yeni bağlayıcılar, kanallar ve özelliklerle genişletmek için resmi ve topluluk eklentilerine göz atın.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    ...
                    'description' => 'CRM uygulamasını sisteminize entegre etmek için uç noktalar, kimlik doğrulama ve örnekler içeren eksiksiz REST API referansı.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'İpuçlarını paylaşmak ve sorunları çözmek için binlerce CRM kullanıcısı ve geliştiricisiyle bağlantı kurun.',
