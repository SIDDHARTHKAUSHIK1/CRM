...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desenvolvido por :crm, um projeto de código aberto da :crm.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Busca rápida',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Tudo o que você precisa para aproveitar ao máximo o CRM Admin — hospedagem, suporte e serviços profissionais, além de extensões e documentação para desenvolvedores.',
            'contact-us' => 'Fale conosco',
            'view-all' => 'Ver tudo',
            'still-need-help-title' => 'Ainda precisa de ajuda?',
            'still-need-help-description' => 'Fale com a equipe CRM sobre hospedagem, desenvolvimento personalizado ou qualquer outra coisa.',

            'services' => [
                'title' => 'Serviços e recursos',
                'cloud-hosting' => [
                    'title' => 'Hospedagem na nuvem',
                    'description' => 'Hospedagem na nuvem gerenciada e econômica — experimente e coloque o CRM na nuvem em minutos, totalmente otimizado e escalável.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensões',
                    'description' => 'Navegue por complementos oficiais e da comunidade para ampliar o CRM com novos conectores, canais e recursos.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    ...
                    'description' => 'Referência completa da API REST com endpoints, autenticação e exemplos para integrar o CRM ao seu stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Conecte-se com milhares de outros usuários e desenvolvedores do CRM para compartilhar dicas e resolver problemas.',
