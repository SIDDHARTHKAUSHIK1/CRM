...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'توسعه یافته توسط :crm، یک پروژه متن باز از :crm.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'جستجوی بزرگ',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'هر آنچه برای بهره‌برداری حداکثری از پنل مدیریت CRM نیاز دارید — میزبانی، پشتیبانی و خدمات حرفه‌ای، به‌همراه افزونه‌ها و مستندات توسعه‌دهندگان.',
            'contact-us' => 'تماس با ما',
            'view-all' => 'مشاهده همه',
            'still-need-help-title' => 'هنوز به کمک نیاز دارید؟',
            'still-need-help-description' => 'درباره میزبانی، توسعه سفارشی یا هر موضوع دیگری با تیم CRM گفتگو کنید.',

            'services' => [
                'title' => 'خدمات و منابع',
                'cloud-hosting' => [
                    'title' => 'میزبانی ابری',
                    'description' => 'میزبانی ابری مدیریت‌شده و مقرون‌به‌صرفه — CRM را در چند دقیقه روی فضای ابری اجرا و راه‌اندازی کنید، کاملاً بهینه و مقیاس‌پذیر.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'افزونه‌ها',
                    'description' => 'افزونه‌های رسمی و انجمنی را مرور کنید تا CRM را با اتصال‌دهنده‌ها، کانال‌ها و قابلیت‌های جدید گسترش دهید.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'مستندات API',
                    'description' => 'مرجع کامل REST API همراه با نقاط پایانی، احراز هویت و نمونه‌ها برای یکپارچه‌سازی CRM با مجموعه ابزار شما.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'با هزاران کاربر و توسعه‌دهنده دیگر CRM ارتباط برقرار کنید تا نکات را به اشتراک بگذارید و مشکلات را حل کنید.',
