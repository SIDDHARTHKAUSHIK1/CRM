<x-admin::layouts>
    ...
    <div class="flex flex-col gap-6" id="activities-workspace">
        ...
        <div id="activities-metrics-section" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-200">
            ...
            <div class="kpi-card group bg-white dark:bg-gray-900 rounded-2xl p-5 border border-slate-200/90 dark:border-gray-800 shadow-2xs flex flex-col justify-between space-y-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-pointer" data-truncate-tooltip tabindex="0">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-slate-500 dark:text-slate-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">Total Activities</span>
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white transition-colors duration-200 group-hover:text-rose-600 dark:group-hover:text-rose-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">
            ...
            <div class="kpi-card group bg-white dark:bg-gray-900 rounded-2xl p-5 border border-slate-200/90 dark:border-gray-800 shadow-2xs flex flex-col justify-between space-y-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-pointer" data-truncate-tooltip tabindex="0">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-slate-500 dark:text-slate-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">Completed</span>
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white transition-colors duration-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">
                        {{ $totalCompletedCount }}
                    </h3>
                    <div class="flex items-center gap-1 text-[11px] font-bold text-emerald-600 dark:text-emerald-400">
                        <span>Today +1</span>
            ...
            <div class="kpi-card group bg-white dark:bg-gray-900 rounded-2xl p-5 border border-slate-200/90 dark:border-gray-800 shadow-2xs flex flex-col justify-between space-y-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-pointer" data-truncate-tooltip tabindex="0">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-slate-500 dark:text-slate-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">Pending</span>
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white transition-colors duration-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">
                        {{ $todayPendingCount }}
                    </h3>
                    <div class="flex items-center gap-1 text-[11px] font-bold text-emerald-600 dark:text-emerald-400">
                        <span>Today +2</span>
            ...
            <div class="kpi-card group bg-white dark:bg-gray-900 rounded-2xl p-5 border border-slate-200/90 dark:border-gray-800 shadow-2xs flex flex-col justify-between space-y-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-pointer" data-truncate-tooltip tabindex="0">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-slate-500 dark:text-slate-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">Calls</span>
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white transition-colors duration-200 group-hover:text-purple-600 dark:group-hover:text-purple-400 truncate outline-hidden" data-truncate-tooltip tabindex="0">
                        {{ $callsCount }}
                    </h3>
