@php($placeholders = app('\Crm\Automation\Helpers\Entity')->getEmailTemplatePlaceholders())

<v-tinymce {{ $attributes }}></v-tinymce>

@pushOnce('scripts')
    <!--
        TODO (@developer-crm): Only this portion is pending; it just needs to be integrated using the Vite bundler. Currently,
