...
use Crm\Core\Acl;
use Crm\Core\Console\Commands\Version;
use Crm\Core\Core;
use Crm\Core\Facades\Acl as AclFacade;
use Crm\Core\Facades\Core as CoreFacade;
use Crm\Core\Facades\Menu as MenuFacade;
use Crm\Core\Facades\SystemConfig as SystemConfigFacade;
use Crm\Core\Menu;
use Crm\Core\SystemConfig;
