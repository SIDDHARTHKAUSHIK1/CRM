...
class LeadRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        ], Arr::except($data, ['entity_type', 'products', 'person'])));
        ...
        if (isset($data['products'])) {
            foreach ($data['products'] as $product) {
                $this->productRepository->create(array_merge(Arr::except($product, ['name']), [
                    'lead_id' => $lead->id,
    ...
    public function update(array $data, $id, $attributes = [])
    {
        ...
        $lead = parent::update(Arr::except($data, ['entity_type', 'products', 'person']), $id);
