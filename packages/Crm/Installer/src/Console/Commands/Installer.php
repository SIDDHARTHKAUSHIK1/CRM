...
namespace Crm\Installer\Console\Commands;
...
use Crm\Installer\Events\ComposerEvents;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'crm-crm:install
    ...
    public function handle()
    {
        ...
        $this->info(app(CRMDatabaseSeeder::class)->run([
            ...
            'currency' => $applicationDetails['currency'] ?? 'INR',
        ]));
