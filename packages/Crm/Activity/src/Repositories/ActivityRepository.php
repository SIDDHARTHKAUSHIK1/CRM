...
use Crm\Activity\Contracts\Activity;
...
class ActivityRepository extends Repository
{
    ...
    {
        return 'Crm\Activity\Contracts\Activity';
    }
    ...
    {
        $activity = parent::create(Arr::except($data, ['participants', 'file', 'name']));
    ...
    {
        $activity = parent::update(Arr::except($data, ['participants', 'file', 'name']), $id, $attribute);
